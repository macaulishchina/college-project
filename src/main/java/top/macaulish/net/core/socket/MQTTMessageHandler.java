...
import top.macaulish.net.mqtt.ApolloMQTTClient;
...
public class MQTTMessageHandler extends AbstractMessageHandler {
    ...
    private static MonitorConfig config = MoziMQTTHandler.loadConfig();
    @Autowired
    protected MoziSocketMonitor MoziMonitor;
    /**
     * 默认MQTT服务器连接信息
     */
    ...
    private static int MONITOR_PORT = 9193;
    ...
    public void onDeliverMessage(JSONObject message) throws Exception {
        MoziMonitor.onDeliverMessage(message);
    }
